...
description: "Set up Anthropic's Claude Code CLI to draft, edit, and maintain your Mintlify documentation, with install steps, authentication, and useful commands."
icon: "asterisk"
---
