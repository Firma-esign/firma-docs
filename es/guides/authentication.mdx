---
title: "Autenticación de API y tokens JWT"
description: "Aprende a autenticar solicitudes de API con claves API y a usar tokens JWT para los editores incrustados de plantillas y solicitudes de firma"
icon: "key"
---
