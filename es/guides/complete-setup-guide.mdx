...
- Precios de **pago por uso** de €0,049/sobre (unos 5 centavos de dólar) - sin suscripciones, sin tarifas ocultas
...
3. Firma ofrece **un entorno unificado** con sobres a un precio tan bajo (solo **€0,049 cada uno**) que probar e iterar no cuesta prácticamente nada.
...
Firma utiliza un modelo de precios **basado en créditos**. Cada sobre (un documento enviado para firmar) cuesta solo **€0,049** (unos 5 centavos de dólar). No hay suscripciones, ni mínimos, ni tarifas sorpresa.
...
[Comienza ahora](https://www.firma.dev) - a €0,049 por sobre, empezar no cuesta prácticamente nada.
