...
El [Acuerdo de Procesamiento de Datos](https://firma.dev/legal/data-processing-agreement) de Firma está publicado y se aplica a todos los clientes. Está incorporado a los Términos y Condiciones por referencia, por lo que no hay nada que solicitar ni firmar por separado. Detalla los subencargados del tratamiento de Firma, establece las garantías para las transferencias internacionales (Cláusulas Contractuales Tipo de la UE) y cubre la conservación y la eliminación de los datos al finalizar el servicio.
