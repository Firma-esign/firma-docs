...
description: "Configurez Windsurf pour votre workflow de documentation"
icon: "water"
---

Configurez l'assistant IA Cascade de Windsurf pour vous aider à rédiger et maintenir votre documentation. Ce guide explique comment configurer Windsurf spécifiquement pour votre workflow de documentation Mintlify.
...
Créez des règles d'espace de travail qui fournissent à Windsurf le contexte de votre projet de documentation et vos standards.
