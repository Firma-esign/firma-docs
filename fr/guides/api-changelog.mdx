...
|---------|------|--------------|-------------|
| [v1.38.0](#v1-38-0) | 2026-09-15 | Version mineure | Prise en charge du catalan : l'ensemble des langues prises en charge par l'API passe à 15, accepté partout où un code de langue est accepté, y compris les paramètres d'espace de travail et d'entreprise, la langue d'e-mail par demande de signature, les conditions du signataire, les modèles d'e-mail par défaut et la langue de la déclaration du cachet d'organisation |
...
Définir le catalan localise l'expérience complète du signataire : les e-mails destinés au signataire, l'interface de la cérémonie de signature, la déclaration de consentement enregistrée lors de l'acceptation des conditions, le format des dates et le certificat de finalisation.
