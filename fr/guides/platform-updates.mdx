...
- Définissez la langue par espace de travail, par entreprise ou par demande de signature individuelle, depuis le tableau de bord ou via l'API. Ce réglage détermine les e-mails d'invitation et de rappel, le format des dates et le certificat de finalisation
