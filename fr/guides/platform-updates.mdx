...
- Lorsque l'URL de signature ne comporte pas de paramètre `lang`, la cérémonie de signature et la déclaration de consentement enregistrée lors de l'acceptation des conditions suivent la langue du navigateur du signataire, détectée automatiquement ; un paramètre `lang` dans l'URL de signature définit la langue à la place
