---
title: "a0.dev e-signature integration"
description: "Add legally binding e-signatures to any a0.dev mobile app with a backend endpoint, an in-app WebView, and the Firma API for real signer flows."
---
