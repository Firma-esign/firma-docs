...
|---------|--------------|-------------|
| [v1.18.0](#v1-18-0) | Minor Release | Editable prefilled data fields, field value mutual exclusivity validation |
...
No breaking changes. Existing prefilled data fields remain locked (read-only) by default. To make them editable, set `prefilled_editable: true` in the field's `format_rules`.
