---
title: "API Changelog"
description: "Track every change to the Firma e-signature API across versions, including new endpoints, breaking changes, deprecations, and migration guidance."
