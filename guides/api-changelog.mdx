...
| `notify_identity_change_webhook` | `boolean` | `false` | Fire a webhook when a signer changes their identity |
...
```json
{
  "settings": {
    ...
    "notify_identity_change_webhook": true
  },
  "recipients": [
    {
      "name": "John Doe",
...
New webhook event: `signing_request.signer_identity_changed` fires when a signer modifies their identity during signing.
