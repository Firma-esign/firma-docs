...
description: "Learn how the Firma API handles versioning, breaking changes, deprecation timelines, and version pinning so your integration stays stable over time."
icon: "code-branch"
---
