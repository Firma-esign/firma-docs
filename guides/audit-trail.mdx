---
title: "Audit Trail"
description: "Retrieve, filter, and export the signing request audit trail from the Firma API to prove every recipient action for compliance and reporting."
