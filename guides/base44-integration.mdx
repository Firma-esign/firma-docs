---
title: "Base44 e-signature integration"
description: "Add legally binding e-signatures to any Base44 app using backend functions or a workspace-level OpenAPI integration wired to the Firma REST API."
---
