---
title: "ChatGPT e-signature integration"
description: "Add legally binding e-signatures to any ChatGPT-powered product using OpenAI function calling, the Codex CLI, or ChatGPT connectors and the Firma API."
---
