---
title: "Claude Code e-signature integration"
description: "Add legally binding e-signatures to any project by connecting Anthropic's Claude Code CLI to Firma's MCP servers and calling the Firma REST API."
---
