---
title: "Cloudflare Workers and Pages e-signature integration"
description: "Add legally binding e-signatures to Cloudflare Workers or Pages apps using bindings, environment secrets, and the Firma REST API for signing flows."
---
