---
title: "Creating workspaces in Firma"
description: "Create isolated Firma workspaces per customer or business unit so each has its own templates, documents, API keys, and envelope usage tracking."
icon: "briefcase"
---
