---
title: "Cursor e-signature integration"
description: "Add legally binding e-signatures to any project using Cursor's AI editor, custom rules, and the Firma REST API to generate signing request code fast."
---
