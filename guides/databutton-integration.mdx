---
title: "Databutton e-signature integration"
description: "Add legally binding e-signatures to any Databutton app using Python backend functions, secrets, and the Firma REST API for signing request workflows."
---
