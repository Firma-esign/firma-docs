...
description: "Embed the Firma signing request editor in your product with JWT authentication so users can build, review, and send requests without leaving your app."
---
