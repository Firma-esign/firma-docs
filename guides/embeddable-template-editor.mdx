...
- [Embed signing interface](/guides/embeddable-signing) for white-label signing (100 req/min)
- [Send signing requests](/guides/sending-signing-request) with custom templates (100 req/min)
- [Set up webhooks](/guides/webhooks) to track template events (60 req/min)