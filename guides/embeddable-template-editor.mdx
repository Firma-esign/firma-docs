...
description: "Embed the Firma template editor in your product with secure JWT authentication so users can create and edit reusable document templates in-app."
---
