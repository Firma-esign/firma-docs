---
title: "InsForge e-signature integration"
description: "Add legally binding e-signatures to any InsForge app using compute functions, secrets, and the Firma REST API to send and track signing requests."
---
