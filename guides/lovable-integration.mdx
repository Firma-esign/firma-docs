---
title: "Lovable e-signature integration"
description: "Add legally binding e-signatures to any Lovable app using Supabase Edge Functions, environment secrets, and webhooks wired to the Firma REST API."
---

Firma lets you add legally binding e-signatures to any Lovable application. Use Supabase Edge Functions to call the Firma API, manage templates, send signing requests, and track completions via webhooks.
