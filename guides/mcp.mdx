...
<Card title="Add Firma to Claude.ai" icon="plus" href="https://claude.ai/new#settings/customize-connectors">
...
<Card title="Add Firma Docs to Claude.ai" icon="plus" href="https://claude.ai/new#settings/customize-connectors">
  Open Claude.ai Connector Settings
</Card>
...
MCP requests are subject to the same [rate limits](/guides/rate-limits) as direct API calls. Each tool call maps to one API request. The Docs MCP server has no rate limits.
