---
title: "Firma MCP integration for AI assistants"
description: "Connect Firma to AI assistants like Claude, ChatGPT, Cursor, and GitHub Copilot with the Model Context Protocol so agents can send real signing requests."
---
