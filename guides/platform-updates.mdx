...
See the [API changelog](api-changelog#v011100) for the `FileFormatRules` schema and field configuration details.
...
See the [API changelog](api-changelog#v011100) for the full `AnchorTag` schema and properties.
