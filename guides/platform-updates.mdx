...
- Enable at the workspace, template, or individual signing request level
- Cascading settings — workspace defaults flow to templates, templates flow to signing requests
...
### Expired Signing Request Page

Signers now see a clear, branded expiration page when a signing request has expired — with the expiration date displayed and a language selector.

### Auto-Purchase Improvements

Enhanced auto-recharge configuration with better credit management and a refreshed UI.

### Captcha Removal

The legacy captcha component has been fully removed from the platform and all translations.

### Full Internationalization

Every new feature ships with complete translations across all 7 supported languages (English, Spanish, Italian, Portuguese, French, German, Greek).
