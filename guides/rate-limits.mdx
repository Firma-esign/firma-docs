---
title: "Rate Limits"
description: "Understand Firma's per-API-key rate limits by operation type, learn how to scale horizontally across workspaces, and handle 429 responses in your app."
icon: "wave-pulse"
---
