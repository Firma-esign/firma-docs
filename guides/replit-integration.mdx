---
title: "Replit e-signature integration"
description: "Add legally binding e-signatures to any Replit app using backend routes, Replit Secrets, Replit Agent, and the Firma REST API for signing flows."
---

Firma lets you add legally binding e-signatures to any Replit application. Use Replit's Node.js or Python backend to call the Firma API, manage templates, send signing requests, and track completions via webhooks.
