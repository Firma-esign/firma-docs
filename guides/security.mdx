...
Firma's [Data Processing Agreement](https://firma.dev/legal/data-processing-agreement) is published and applies to all customers. It is incorporated into the Terms and Conditions by reference, so there is nothing to request or sign separately. It names Firma's sub-processors, sets out the international transfer safeguards (EU Standard Contractual Clauses), and covers retention and deletion on termination.
