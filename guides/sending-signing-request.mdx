...
description: "Create and send Firma signing requests to recipients via the API, including document upload, fields, signer routing, reminders, and status tracking."
icon: "paper-plane"
---
