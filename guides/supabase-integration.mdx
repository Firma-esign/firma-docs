---
title: "Supabase e-signature integration"
description: "Add legally binding e-signatures to any Supabase application using Edge Functions, Postgres, secrets, and webhooks wired to the Firma REST API."
---
