---
title: "Trae e-signature integration"
description: "Add legally binding e-signatures to apps you build in Trae by wiring Firma's MCP servers into a backend function that calls the Firma REST API."
---
