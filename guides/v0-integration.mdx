---
title: "v0 e-signature integration"
description: "Add legally binding e-signatures to any v0 app using Next.js route handlers, environment variables, and the Firma REST API for signing flows."
---
