---
title: "Wasp Open SaaS e-signature integration"
description: "Add legally binding e-signatures to any Wasp application using server-side actions, environment variables, and the Firma REST API for signing flows."
---
