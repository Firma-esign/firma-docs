...
title: "Webhooks"
icon: "webhook"
description: "Set up secure Firma webhooks to receive real-time notifications for signing request events, verify signatures, and handle retries in your backend."
---
