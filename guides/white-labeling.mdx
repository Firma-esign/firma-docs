...
📘 See the [Email Domains API Reference](/api-reference/v01.15.00/email-domains/list-company-domains) for complete endpoint documentation.
...
📘 See the [Email Templates API Reference](/api-reference/v01.15.00/email-templates/list-workspace-email-templates) for complete endpoint documentation.
