...
- `signing_request_email_header` (string) - Custom header text for signing invitation emails
- `signing_request_email_body` (string) - Custom body text for signing invitation emails
...
- `signing_request_email_header` (string, optional) - Custom header text for signing emails (max 255 characters)
- `signing_request_email_body` (string, optional) - Custom body text for signing emails (max 2000 characters)
