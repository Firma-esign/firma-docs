...
icon: "briefcase"
description: "Configure Firma workspace settings including email templates, team information, timezone, and default preferences that apply to all signing requests."
---
