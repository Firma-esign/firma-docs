---
title: "Changelog API"
description: "Un changelog completo di tutte le versioni dell'API e delle relative modifiche"
icon: "clock-rotate-left"
---

Questo documento fornisce un changelog dettagliato di tutte le versioni dell'API di Firma, documentando nuove funzionalità, breaking change e miglioramenti tra le varie release.

## Riepilogo delle versioni

| Versione | Tipo di release | Modifiche principali |
|---------|--------------|-------------|
...
| [v1.24.0](#v1-24-0) | Minor Release | Workspace test API keys: create returns a live+test pair, reads return both, key_type-aware regenerate/expire |
...
| [v1.22.0](#v1-22-0) | Minor Release | Delete signing request endpoint, signing_request.deleted webhook event |
...
| [v1.19.0](#v1-19-0) | Minor Release | Logo management endpoints, workspace icon_url |
...
**Tipo di release:** Patch Release

[Scarica la specifica OpenAPI](/api-reference/v01.27.00/openapi-v01.27.00.json)
...
| Endpoint | Nuovo campo di risposta | Tipo | Descrizione |
|----------|--------------------|------|-------------|
...
Nessuna breaking change. These are documentation-only additions describing fields the API already returns. Le integrazioni esistenti non sono interessate. If you parse settings objects, you can now rely on the documented `show_qr_code`, `allow_presigning_download`, `identity_editable_fields`, and `notify_identity_change_email` fields, and on `emails_sent` / `recipients_failed` in cancel and resend responses.

---

## v1.26.0

**Tipo di release:** Minor Release

[Scarica la specifica OpenAPI](/api-reference/v01.26.00/openapi-v01.26.00.json)
...
[Scarica la specifica OpenAPI](/api-reference/v01.25.02/openapi-v01.25.02.json)
...
**Migrazione:** ensure every field you send on a template-based create references an existing template field. If you were relying on extra/unmatched fields being ignored, remove them.
...
[Scarica la specifica OpenAPI](/api-reference/v01.25.01/openapi-v01.25.01.json)
...
**Guida alla migrazione:** No action required for clients that already treat any non-2xx response as a failure. If you previously special-cased the opaque `500` from this endpoint, switch to branching on the HTTP status / `code`: `400` and `422` mean "fix the request, then retry," `402` means "add credits."
...
[Scarica la specifica OpenAPI](/api-reference/v01.25.00/openapi-v01.25.00.json)
...
**Guida alla migrazione:** No action required. All five fields are additive and nullable. To brand the embedded editors, send any of the new `color_*` fields (valid `#rrggbb` hex, or `null` to clear) to the company- or workspace-settings endpoint.
...
[Scarica la specifica OpenAPI](/api-reference/v01.24.00/openapi-v01.24.00.json)
...
**Guida alla migrazione:** No action required. To use test mode, read `test_api_key` from any workspace create/get response and send it as the `Authorization` key for requests you want to run in test mode.
...
[Scarica la specifica OpenAPI](/api-reference/v01.23.00/openapi-v01.23.00.json)
...
Nessuna breaking change. This release is additive, and no action is required for existing integrations.
...
[Scarica la specifica OpenAPI](/api-reference/v01.22.01/openapi-v01.22.01.json)
...
Nessuna breaking change. The `400 "Cannot delete primary domain"` and "cannot delete the only domain" responses are removed from both `DELETE` domain endpoints; they now return `200` in those cases. Integrations that special-cased that `400` can drop the handling.
...
[Scarica la specifica OpenAPI](/api-reference/v01.22.00/openapi-v01.22.00.json)
...
Nessuna breaking change. The new `DELETE` method on `/signing-requests/{id}` is purely additive. Le integrazioni esistenti non sono interessate.
...
[Scarica la specifica OpenAPI](/api-reference/v01.21.01/openapi-v01.21.01.json)
...
Nessuna breaking change. Existing workspace webhook configurations are unaffected. Use `PATCH /workspaces/{id}` with `webhook_enabled: true` to enable workspace webhooks via API instead of the dashboard.
...
[Scarica la specifica OpenAPI](/api-reference/v01.21.00/openapi-v01.21.00.json)
...
Nessuna breaking change. Existing configurations continue to send emails from `support@{domain}` by default. Set `email_local_part` at the company or workspace level to customize the sender address.
...
Nessuna breaking change. Existing signing requests and templates continue to work as before (auto-scroll enabled by default). To disable auto-scroll, set `disable_guided_navigation: true` at the desired level.

[Scarica la specifica OpenAPI](/api-reference/v01.20.00/openapi-v01.20.00.json)
...
[Scarica la specifica OpenAPI](/api-reference/v01.19.00/openapi-v01.19.00.json)

---

## v1.18.0

**Data di rilascio:** May 5, 2026
...
Nessuna breaking change. New features are opt-in:
...
**Data di rilascio:** April 30, 2026

**[Scarica la specifica OpenAPI](/api-reference/v01.17.00/openapi-v01.17.00.json)**
...
Si tratta di una modifica additiva senza breaking change. Le integrazioni esistenti continuano a funzionare senza modifiche.
...
**Data di rilascio:** April 27, 2026

**[Scarica la specifica OpenAPI](/api-reference/v01.16.00/openapi-v01.16.00.json)**
...
| Stato della richiesta di firma | Risposta |
|-----------------------|----------|
...
**Scadenza URL:** The `download_url` is a pre-signed URL. Fetch the endpoint again after `expires_at` to get a fresh URL.
...
**[Scarica la specifica OpenAPI](/api-reference/v01.15.03/openapi-v01.15.03.json)**
...
| Nuovo campo | Sostituisce (deprecato) | Note |
|-----------|----------------------|-------|
...
**Data di rilascio:** April 23, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.15.02/openapi-v01.15.02.json)
...
**Data di rilascio:** April 17, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.15.01/openapi-v01.15.01.json)
...
**Data di rilascio:** April 16, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.15.00/openapi-v01.15.00.json)
...
**Data di rilascio:** April 12, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.14.00/openapi-v01.14.00.json)
...
**Data di rilascio:** April 12, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.13.00/openapi-v01.13.00.json)
...
Si tratta di una modifica additiva senza breaking change. Existing integrations are not affected.
...
**Data di rilascio:** April 2, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.12.01/openapi-v01.12.01.json)
...
Si tratta di una patch release senza breaking change. Tutto il comportamento API esistente rimane invariato.

---

## v01.12.00

**Data di rilascio:** March 26, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.12.00/openapi-v01.12.00.json)
...
**URL del server:** `https://mcp.firma.dev/mcp`
...
**Trasporto:** [Streamable HTTP](https://modelcontextprotocol.io/specification/2025-03-26/basic/transports#streamable-http) — compatible with Claude Code, Claude Desktop, Claude.ai, and any MCP client supporting the standard.
...
**Data di rilascio:** March 19, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.11.00/openapi-v01.11.00.json)
...
**Data di rilascio:** March 10, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.10.00/openapi-v01.10.00.json)
...
**Operatori supportati:** `is_filled`, `is_empty`, `equals`, `not_equals`, `contains`, `not_contains`, `greater_than`, `less_than`, `greater_than_or_equal`, `less_than_or_equal`
...
| Parametro aggiunto | Tipo | Descrizione |
|-----------------|------|-------------|
...
Nessuna breaking change. All new features are additive:
...
[Scarica la specifica OpenAPI](/api-reference/v01.09.00/openapi-v01.09.00.json)
...
Nessuna breaking change. The `require_otp_verification` field defaults to `null` (inherit), so existing behavior is unchanged. The replace document endpoint is purely additive.

---

## v01.08.00

**Data di rilascio:** March 3, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.08.00/openapi-v01.08.00.json)
...
| Tipo di email | Quando viene inviata |
|------------|----------|
...
**Gerarchia dei template:** Workspace templates → Company templates → Built-in defaults.
...
| Schema | Specifica precedente | Corretta |
|--------|-----------|------------|
...
**Data di rilascio:** February 25, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.07.00/openapi-v01.07.00.json)
...
| Campo deprecato | Tipo | Usare invece |
|------------------|------|-------------|
...
Nessuna breaking change. The `hand_drawn_only` setting defaults to `false`, preserving existing behavior. Deprecated top-level integer fields are purely additive.

---

## v01.06.00

**Data di rilascio:** February 12, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.06.00/openapi-v01.06.00.json)
...
Nessuna breaking change. Both old and new field type names are accepted. The split PDF download fields are purely additive.

---

## v01.05.00

**Data di rilascio:** February 5, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.05.00/openapi-v01.05.00.json)
...
Nessuna breaking change. Email validation warnings are purely additive and do not affect existing integrations.

---

## v01.04.00

**Data di rilascio:** January 31, 2026  
[Scarica la specifica OpenAPI](/api-reference/v01.04.00/openapi-v01.04.00.json)
...
[Scarica la specifica OpenAPI](/api-reference/v01.03.00/openapi-v01.03.00.json)
...
[Scarica la specifica OpenAPI](/api-reference/v01.02.00/openapi-v01.02.00.json)

### Informazioni utente estese
...
### Modifiche al formato di risposta
...
[Scarica la specifica OpenAPI](/api-reference/v01.01.00/openapi-v01.01.00.json)
...
[Scarica la specifica OpenAPI](/api-reference/v01.00.02/openapi-v01.00.02.json)
...
[Scarica la specifica OpenAPI](/api-reference/v01.00.01/openapi-v01.00.01.json)
