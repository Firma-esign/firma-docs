...
description: "Um changelog abrangente de todas as versões da API e suas mudanças"
icon: "clock-rotate-left"
---

Este documento fornece um changelog detalhado de todas as versões da API do Firma, documentando novos recursos, mudanças disruptivas e melhorias entre cada versão.

## Resumo das versões

| Versão | Tipo de lançamento | Principais mudanças |
|---------|--------------|-------------|
| [v1.27.0](#v1-27-0) | Lançamento de patch | Settings schemas documented: signing-request responses now expose `show_qr_code`, `allow_presigning_download`, `identity_editable_fields`, `notify_identity_change_email`; template responses expose `show_qr_code`; `cancel` returns `emails_sent`; `resend` returns `recipients_failed`; new `TemplateSettings` and `LegacyDocumentSettings` schemas |
| [v1.26.0](#v1-26-0) | Lançamento menor | Workspace settings: signing button label overrides, QR code toggle, presigning download toggle, partial watermark toggle |
| [v1.25.2](#v1-25-2) | Lançamento de patch | Provided fields that match no template field now return `400` (previously ignored silently) on `POST /signing-requests` and `/create-and-send`; field `type` values are matched case-insensitively |
| [v1.25.1](#v1-25-1) | Lançamento de patch | `create-and-send` send-step failures now return the real status (`400`/`402`/`422`) with a machine-readable `code`, instead of masking them as `500` |
| [v1.25.0](#v1-25-0) | Lançamento menor | Editor brand colors: 5 new appearance fields (`color_accent`, `color_accent_fg`, `color_canvas`, `color_muted`, `color_muted_fg`) on company + workspace settings; resolved `color_palette` now returns 11 keys |
| [v1.24.0](#v1-24-0) | Lançamento menor | Workspace test API keys: create returns a live+test pair, reads return both, key_type-aware regenerate/expire |
| [v1.23.0](#v1-23-0) | Lançamento menor | Signer terms endpoints, company settings endpoints, terms acceptance settings |
| [v1.22.1](#v1-22-1) | Lançamento de patch | Primary/only custom email domain can now be deleted (DELETE no longer returns 400) |
| [v1.22.0](#v1-22-0) | Lançamento menor | Delete signing request endpoint, signing_request.deleted webhook event |
| [v1.21.1](#v1-21-1) | Lançamento de patch | Workspace webhook activation via API |
| [v1.21.0](#v1-21-0) | Lançamento menor | Custom email sender local-part setting |
| [v1.20.0](#v1-20-0) | Lançamento menor | Guided navigation control setting |
| [v1.19.0](#v1-19-0) | Lançamento menor | Logo management endpoints, workspace icon_url |
| [v1.18.0](#v1-18-0) | Lançamento menor | Identity editable fields, editable prefilled data, field value validation |
| [v1.17.0](#v1-17-0) | Lançamento menor | Color customization for signing experience |
| [v1.16.0](#v1-16-0) | Lançamento menor | Download Signing Request endpoint |
| v1.15.3 | Minor | Clean field aliases |
| [v01.15.02](#v01-15-02) | Lançamento de patch | Added missing field types to create-and-send fields schema |
| [v01.15.01](#v01-15-01) | Lançamento de patch | Added Russian and Polish language support to API schemas |
| [v01.15.00](#v01-15-00) | Lançamento menor | Workspace Webhooks, Secret Rotation/Status Endpoints |
| [v01.14.00](#v01-14-00) | Lançamento menor | Approver/CC Designations, Approval Field Types |
| [v01.13.00](#v01-13-00) | Lançamento menor | Stamp Field Type |
| [v01.12.01](#v01-12-01) | Lançamento de patch | Custom Field Variable Names (`variable_defined_name`) |
| [v01.12.00](#v01-12-00) | Lançamento menor | MCP Server Integration |
| [v01.11.00](#v01-11-00) | Lançamento menor | File Upload Fields, Anchor Tags, Field Background Colors, Signing Order Default Change |
| [v01.10.00](#v01-10-00) | Lançamento menor | Conditional Fields, DOCX Support, Audit Trail, Signature Frame Control |
| [v01.09.00](#v01-09-00) | Lançamento menor | OTP Verification, Replace Template Document |
| [v01.08.00](#v01-08-00) | Lançamento menor | Email Templates API, Language Support, Webhook Observability |
| [v01.07.00](#v01-07-00) | Lançamento menor | Hand-Drawn Signatures, Legacy Settings Fields |
| [v01.06.00](#v01-06-00) | Lançamento menor | Split PDF Downloads, Field Type Normalization |
| [v01.05.00](#v01-05-00) | Lançamento de patch | Email Validation Warnings |
| [v01.04.00](#v01-04-00) | Lançamento menor | New Field Types, PATCH Field Operations, Template User Matching |
| [v01.03.00](#v01-03-00) | Lançamento menor | Email Domains API, Credit Cost, Declined Status |
| [v01.02.00](#v01-02-00) | Lançamento menor | Enhanced User Fields, Ready-to-Send Indicators |
| [v01.01.00](#v01-01-00) | Lançamento menor | Template CRUD, API Key Management, Comprehensive Updates |
| [v01.00.02](#v01-00-02) | Lançamento de patch | Custom Fields API |
| [v01.00.01](#v01-00-01) | Lançamento inicial | Core API Features |

---

## v1.27.0

**Tipo de lançamento:** Lançamento de patch

[Baixar especificação OpenAPI](/api-reference/v01.27.00/openapi-v01.27.00.json)
...
**Tipo de lançamento:** Lançamento menor

[Baixar especificação OpenAPI](/api-reference/v01.26.00/openapi-v01.26.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.25.02/openapi-v01.25.02.json)
...
**Migração:** ensure every field you send on a template-based create references an existing template field. If you were relying on extra/unmatched fields being ignored, remove them.
...
[Baixar especificação OpenAPI](/api-reference/v01.25.01/openapi-v01.25.01.json)
...
**Guia de migração:** No action required for clients that already treat any non-2xx response as a failure. If you previously special-cased the opaque `500` from this endpoint, switch to branching on the HTTP status / `code`: `400` and `422` mean "fix the request, then retry," `402` means "add credits."
...
[Baixar especificação OpenAPI](/api-reference/v01.25.00/openapi-v01.25.00.json)
...
**Guia de migração:** No action required. All five fields are additive and nullable. To brand the embedded editors, send any of the new `color_*` fields (valid `#rrggbb` hex, or `null` to clear) to the company- or workspace-settings endpoint.
...
[Baixar especificação OpenAPI](/api-reference/v01.24.00/openapi-v01.24.00.json)
...
**Guia de migração:** No action required. To use test mode, read `test_api_key` from any workspace create/get response and send it as the `Authorization` key for requests you want to run in test mode.
...
[Baixar especificação OpenAPI](/api-reference/v01.23.00/openapi-v01.23.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.22.01/openapi-v01.22.01.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.22.00/openapi-v01.22.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.21.01/openapi-v01.21.01.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.21.00/openapi-v01.21.00.json)
...
- **Configurações da solicitação de assinatura** schema: added `disable_guided_navigation` (boolean, nullable)
...
[Baixar especificação OpenAPI](/api-reference/v01.20.00/openapi-v01.20.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.19.00/openapi-v01.19.00.json)

---

## v1.18.0

**Data de lançamento:** May 5, 2026
...
**Data de lançamento:** April 30, 2026

**[Baixar especificação OpenAPI](/api-reference/v01.17.00/openapi-v01.17.00.json)**
...
**Data de lançamento:** April 27, 2026

**[Baixar especificação OpenAPI](/api-reference/v01.16.00/openapi-v01.16.00.json)**
...
**Expiração da URL:** The `download_url` is a pre-signed URL. Fetch the endpoint again after `expires_at` to get a fresh URL.
...
**[Baixar especificação OpenAPI](/api-reference/v01.15.03/openapi-v01.15.03.json)**
...
**Data de lançamento:** April 23, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.15.02/openapi-v01.15.02.json)
...
**Data de lançamento:** April 17, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.15.01/openapi-v01.15.01.json)
...
**Data de lançamento:** April 16, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.15.00/openapi-v01.15.00.json)
...
**Data de lançamento:** April 12, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.14.00/openapi-v01.14.00.json)
...
**Data de lançamento:** April 12, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.13.00/openapi-v01.13.00.json)
...
**Data de lançamento:** April 2, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.12.01/openapi-v01.12.01.json)
...
**Data de lançamento:** March 26, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.12.00/openapi-v01.12.00.json)
...
**Transporte:** [Streamable HTTP](https://modelcontextprotocol.io/specification/2025-03-26/basic/transports#streamable-http) — compatible with Claude Code, Claude Desktop, Claude.ai, and any MCP client supporting the standard.
...
**Data de lançamento:** March 19, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.11.00/openapi-v01.11.00.json)
...
**Data de lançamento:** March 10, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.10.00/openapi-v01.10.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.09.00/openapi-v01.09.00.json)
...
**Data de lançamento:** March 3, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.08.00/openapi-v01.08.00.json)
...
**Hierarquia de templates:** Workspace templates → Company templates → Built-in defaults.
...
**Data de lançamento:** February 25, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.07.00/openapi-v01.07.00.json)
...
**Data de lançamento:** February 12, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.06.00/openapi-v01.06.00.json)
...
**Data de lançamento:** February 5, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.05.00/openapi-v01.05.00.json)
...
**Data de lançamento:** January 31, 2026  
[Baixar especificação OpenAPI](/api-reference/v01.04.00/openapi-v01.04.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.03.00/openapi-v01.03.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.02.00/openapi-v01.02.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.01.00/openapi-v01.01.00.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.00.02/openapi-v01.00.02.json)
...
[Baixar especificação OpenAPI](/api-reference/v01.00.01/openapi-v01.00.01.json)
