---
title: "ChatGPT"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer app com ChatGPT usando function calling, o Codex CLI ou conectores do ChatGPT."
---

O Firma permite adicionar assinaturas eletrônicas legalmente vinculantes to anything built on OpenAI. Use the Responses API's function calling to let your AI agents send signing requests on demand, connect Firma's MCP servers to Codex CLI so the AI generates accurate integration code, or add Firma as a ChatGPT connector so you can manage signing requests from the ChatGPT desktop app.
...
### Passo 2: Add the Firma MCP servers
...
### Passo 3: Use Firma from Codex CLI
...
### Passo 3: Use Firma from ChatGPT
