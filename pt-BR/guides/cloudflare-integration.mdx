---
title: "Cloudflare"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a apps Cloudflare Workers ou Pages usando a API do Firma."
---

O Firma permite adicionar assinaturas eletrônicas legalmente vinculantes to any application running on Cloudflare. Call the Firma API from Workers or Pages Functions to create templates, send signing requests, and track completions via webhooks.
...
### Passo 1: Create a Worker project
...
### Passo 2: Store your API key as a secret
...
### Passo 3: Create a Worker to send signing requests
...
### Passo 1: Set up your Pages project
...
### Passo 3: Create a Pages Function to send signing requests
