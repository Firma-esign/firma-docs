---
title: "Workspaces"
description: "Workspaces permitem criar ambientes isolados para cada um dos seus clientes ou unidades de negócio. Cada workspace tem seus próprios templates, documentos e uso de envelopes — para que as equipes permaneçam separadas sem esforço extra."
icon: "briefcase"
---
...
The `api_key` is the workspace's live key and `test_api_key` is its test key. See [Authentication](authentication) for how test mode works.
