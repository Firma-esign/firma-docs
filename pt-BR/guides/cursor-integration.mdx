---
title: "Cursor"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer projeto usando os recursos de IA do Cursor e a API do Firma."
---
...
<Warning>
  Nunca exponha sua chave de API in frontend code. Always call the Firma API from server-side routes or backend functions.
</Warning>
