...
<Warning>
  Nunca exponha sua chave de API in frontend code. Always call the Firma API from backend functions, not from React components directly.
</Warning>
