---
title: "Editor de solicitação de assinatura incorporável"
description: "Incorpore o editor de solicitação de assinatura no seu produto com autenticação JWT segura."
---
...
<Warning>
**Security**: Nunca exponha sua chave de API in client-side code. Always generate JWT tokens from your secure backend.
</Warning>
...
<Warning>
**Nunca exponha sua chave de API in client-side code.** Always generate JWT tokens from a secure server endpoint.
</Warning>
