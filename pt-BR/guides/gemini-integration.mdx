---
title: "Gemini"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer app com Gemini usando function calling, o Gemini CLI ou Gemini Code Assist."
---

O Firma permite adicionar assinaturas eletrônicas legalmente vinculantes to anything built on Gemini. Use the Gemini API's function calling to let your AI agents send signing requests on demand, connect Firma's MCP servers to the Gemini CLI so the AI generates accurate integration code, or wire up webhooks to track completions. This guide covers all three.
...
### Passo 2: Declare a function and handle tool calls
...
Once connected, you can ask the CLI things like:
