---
title: "InsForge"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer app InsForge usando funções de compute apoiadas pela API REST do Firma."
---

O Firma permite adicionar assinaturas eletrônicas legalmente vinculantes to any app built on InsForge. Because InsForge gives your coding agent compute, hosting, auth, and storage out of the box, you can drop Firma into an existing agent-built app by adding one compute function and one webhook handler.
...
<Warning>
  Nunca exponha sua chave de API in frontend code. Always call the Firma API from compute functions where secrets are kept secure.
</Warning>

### Passo 2: Create a compute function to send signing requests
...
### Passo 3: Call the function from your app UI
...
### Passo 1: Add the Firma Docs MCP server
