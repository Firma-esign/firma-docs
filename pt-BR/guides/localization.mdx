...
title: "Localização"
icon: "globe"
description: "O Firma suporta 7 idiomas prontos para uso com detecção automática de idioma, persistência por usuário e substituições amigáveis para incorporação."
---
