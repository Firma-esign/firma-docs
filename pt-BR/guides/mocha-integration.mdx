---
title: "Mocha"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer app Mocha usando funções de backend geradas por IA e a API do Firma."
---

O Firma permite adicionar assinaturas eletrônicas legalmente vinculantes to any Mocha application. Store your Firma API key as a secret, ask Mocha's AI to call the API from your backend, and your users can send signing requests directly from your app.
