---
title: "Rork"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer app móvel Rork usando funções serverless e a API REST do Firma."
---

O Firma permite adicionar assinaturas eletrônicas legalmente vinculantes to any mobile application built with [Rork](https://rork.app). Since Rork generates React Native (Expo) apps, you can call the Firma API from a lightweight backend and render the signing experience in a WebView within your mobile app.
