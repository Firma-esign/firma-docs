---
title: "Salesforce"
description: "Adicione assinaturas eletrônicas legalmente vinculantes a qualquer organização Salesforce usando Flow, Apex ou Agentforce."
---
...
### Passo 1: Register Firma as an External Service
...
### Passo 1: Create the Apex REST endpoint
...
### Passo 2: Verify the webhook signature
...
### Passo 3: Expose the endpoint publicly
...
### Passo 4: Register the webhook in Firma
