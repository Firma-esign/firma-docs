---
title: "Mistral"
description: "Додайте юридично зобов’язуючі електронні підписи до any Mistral agent, conversation, or Vibe workflow using Firma's MCP Connector."
---
...
Firma exposes its API as an MCP server, which means a Mistral agent can send signing requests, list templates, and check signing status as native tool calls. Цей посібник охоплює three integration paths:
...
### Крок 2: Use the Connector in a conversation
...
### Крок 3: Build a persistent Firma agent
...
tools = [
    {
        ...
        "function": {
            ...
            "description": "Створіть signing request from a Firma template and send it to a recipient.",
            "parameters": {
                "type": "object",
                "properties": {
