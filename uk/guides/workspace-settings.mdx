...
```json
{
  ...
  "email_body": "Please review and sign the document at your earliest convenience. Якщо у вас виникнуть питання, contact our team.",
...
Update workspace settings. Ви можете update one or more fields — only provided fields will be updated.
...
curl -X PUT "https://api.firma.dev/functions/v1/signing-request-api/workspace/123e4567-e89b-12d3-a456-426614174000/settings" \
  ...
  -d '{
    "email_header": "Action Обов’язково: Sign Your Agreement",
...
```
Header: "Action Обов’язково: Review and Sign Your Contract"
Body: "Thank you for choosing our services. Please review and sign the attached contract at your earliest convenience. Якщо у вас виникнуть питання or concerns, please contact us at contracts@company.com or call (555) 123-4567."
```
...
Check `X-RateLimit-Reset` header for when ви можете retry.
